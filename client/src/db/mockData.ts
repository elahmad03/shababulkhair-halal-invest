...
export const mockInvestmentCycles: InvestmentCycle[] = [
  ...
  },
  {
    ...
    description: "this investment is diversified in many sectors",
     totalProfitRealized: 12000000n,
    investorProfitPool: 96000000n,
    organizationProfitShare: 24000000n,
...
export const mockOrganizationalLedger: OrganizationalLedger[] = [
  ...
  },
  {
    id: 2,
    entryType: "expense",
    source: "purchased a hosting provider",
    amount: 17000000n,
    date: new Date("2025-006-01"),
    relatedCycleId: 4,
    recordedBy: 1,
    createdAt: new Date("2025-06-01"),
  },
...
export const mockData = {
  ...
  businessVentures: mockBusinessVentures,
  organizationalLedger: mockOrganizationalLedger,
  userPreferences: mockUserPreferences,
  withdrawalRequests: mockWithdrawalRequests,
  emergencyWithdrawalRequests: mockEmergencyWithdrawalRequests,
  deceasedUserClaims: mockDeceasedUserClaims,
