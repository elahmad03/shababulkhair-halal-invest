...
router.get("/admin", authorizeRoles("ADMIN", "COMMITTEE"), UserController.listUsers);

// GET /admin/users/:id - Get single user details
router.get("/admin/:id", authorizeRoles("ADMIN", "COMMITTEE"), UserController.getUserDetail);

// GET /admin/users/:id/kyc - Get user's KYC profile
router.get("/admin/:id/kyc", authorizeRoles("ADMIN", "COMMITTEE"), UserController.getUserKyc);
...
router.get("/admin/:id/investments", authorizeRoles("ADMIN", "COMMITTEE"), UserController.getUserInvestments);

// GET /admin/users/:id/transactions - Get user's transactions
router.get("/admin/:id/transactions", authorizeRoles("ADMIN", "COMMITTEE"), UserController.getUserTransactions);
